...
from scrapers.computrabajo.searches import FULLSTACK_TODAS as _SRC
from analytics.pipeline import run_pipeline
from analytics.master_sync import sync_to_master

async def main():
    """Ejecuta el ciclo de captura (todas, sin filtro) para Desarrollador FullStack en Antioquia."""
